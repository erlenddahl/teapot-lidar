# From here, slightly modified for performance in our use case: https://github.com/danielhavir/voxelize3d/blob/master/voxelize.py
...
def voxelize(
    ...
    voxels = np.zeros((max_num_voxels, points.shape[-1]), dtype=points_copy.dtype)
    ...
    for i, coord in enumerate(points_coords):
        ...
        if voxel_idx == -1:
            ...
            voxels[voxel_idx] = points_copy[i]
